...
export class QuoteComponent implements OnInit {
  quotes = [
    new Quotesz('Isaac', 'Whoever is happy will make others happy too', 'Anne Frank', 9 , 0),
    new Quotesz('John', 'Life is either a daring adenture or nothing at all.', 'joel', 8 , 9)
  ];
